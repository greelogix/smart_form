...
class _SmartChoiceFieldState<T extends Object>
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveStyle =
        widget.style ?? provider?.defaultStyle ?? SmartStyle.adaptive;
    final platform = Theme.of(context).platform;
    final bool useCupertino =
        effectiveStyle == SmartStyle.cupertino ||
        (effectiveStyle == SmartStyle.adaptive &&
                ...
                for (var option in widget.options)
                  option.value: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        if (option.iconCupertino != null)
                          Icon(option.iconCupertino, size: 16),
                        if (option.iconCupertino != null &&
